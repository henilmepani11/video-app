...
class VideoProgressBar1 extends StatefulWidget {
  ...
  _VideoProgressBar1State createState() {
    return _VideoProgressBar1State();
  }
}

class _VideoProgressBar1State extends State<VideoProgressBar1> {
  void listener() {
    if (!mounted) return;
    setState(() {});
  }
...
class _ProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final baseOffset = size.height - barHeight;
    ...
    canvas.drawRRect(
      ...
      Paint()..color = AppColor.sliderColor,
    );
    ...
    for (final DurationRange range in value.buffered) {
      ...
      canvas.drawRRect(
        ...
        Paint()..color = AppColor.primaryColor.withOpacity(0.2),
      );
    }
    canvas.drawRRect(
      RRect.fromRectAndRadius(
    ...
    canvas.drawCircle(Offset(playedPart, baseOffset + barHeight / 2),
        handleHeight, Paint()..color = AppColor.primaryColor);
    canvas.drawCircle(Offset(playedPart, baseOffset + barHeight / 2),
        handleHeight / 1.6, Paint()..color = Colors.white);
  }
}
